...
|<sub>toAmount</sub>|<sub>N</sub>|<sub>20</sub>|<sub>전환수량</sub>|<sub>전환수량 = 요청수량 * 환율</sub>|<sub>1</sub>|
|<sub>exchangeRate</sub>|<sub>Y</sub>|<sub>20</sub>|<sub>환율</sub>|<sub>Exchange Rate Inquiry API에서 수신 받은 환율 사용</sub>|<sub>10%</sub>|
|<sub>internalAddress</sub>|<sub>N</sub>|<sub>128</sub>|<sub>내부주소</sub>|<sub>Privatge Token(Internal Token) Address</sub>|<sub></sub>|
...
인출은 Privatge Token을 외부주소로 전송하는 기능입니다. 외부주소 전송된 Privatge Token은 거래소 등 다양한 분야에 자유롭게 사용 가능합니다.
